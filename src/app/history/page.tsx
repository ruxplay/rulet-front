...
export default function UserHistoryPage(): React.ReactElement {
      ...
      <div className="admin-content">
        <div className="history-controls">
          ...
          <div className="row">
            ...
            <div className="col">
              <label>&nbsp;</label>
              <button className="btn-secondary" onClick={() => { setOffset(0); void refetch(); }} disabled={!username}>
                Aplicar fechas
              </button>
            </div>
          </div>
        ...
        {!username && (
          <div className="empty-state">
            ...
            <p>
              Ir al <Link href="/dashboard" className="admin-link">Dashboard</Link>
            </p>
          </div>
        )}
        ...
        {username && isForbidden && (
          <div className="error-state">
            <span>No tienes permiso para ver este historial.</span>
          </div>
        )}
        ...
        {username && !isLoading && !isFetching && data && (
          <div className="history-results">
            ...
            {(() => {
              ...
              const displayed = (data.items || []).filter((it) => allowed.has(it.type as UserHistoryItemType));
              if (displayed.length === 0) {
                return <div className="empty-state">Sin resultados para los filtros aplicados.</div>;
              }
              return (
